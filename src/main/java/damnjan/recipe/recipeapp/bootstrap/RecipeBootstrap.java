package damnjan.recipe.recipeapp.bootstrap;

import damnjan.recipe.recipeapp.domain.*;
import damnjan.recipe.recipeapp.enums.Difficulty;
import damnjan.recipe.recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("https://www.coolinarika.com/recept/guacamole/");
        guacRecipe.setServings(4);
        guacRecipe.setSource("Simply Recepies");
        ...
        tacosRecipe.setUrl("https://www.coolinarika.com/recept/tacos/");
        tacosRecipe.setServings(5);
        tacosRecipe.setSource("Simply Recepies");
